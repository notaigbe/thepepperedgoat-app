...
const MODIFICATION_WINDOW_MS = 5 * 60 * 1000; // 5 minutes
...
export default function OrderDetailScreen() {
  ...
  const handleCancelOrder = async () => {
    try {
      ...
      const response = await fetch(`${process.env.EXPO_PUBLIC_SUPABASE_URL}/functions/v1/cancel-order`, {
        method: 'POST',
        headers: {
  ...
  const handleModifyOrder = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.EXPO_PUBLIC_SUPABASE_URL}/functions/v1/modify-order`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`,
    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: currentColors.background }]}>
        <View style={styles.errorContainer}>
          <IconSymbol name="error" size={64} color={currentColors.textSecondary} />
        ...
        <View style={styles.container}>
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            {canModify && (
              ...
              >
                <IconSymbol name="schedule" size={24} color={currentColors.highlight} />
              ...
              <View style={styles.actionButtons}>
                ...
                >
                  <Pressable
                    ...
                    disabled={modifying}
                  >
                    <IconSymbol name="edit" size={20} color={currentColors.background} />
                ...
                >
                  <Pressable
                    ...
                    disabled={cancelling}
                  >
                    <IconSymbol name="cancel" size={20} color="#FFF" />
